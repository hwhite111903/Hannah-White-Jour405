...
The shuttle bus had a percentage change of 39.46 through the years, and is one of the highest fees in the list. A story could be why are students being upcharged when it seems the buses haven't changed much since the beginning of when the data was being collected. Or even how many students actually use the shuttle bus on a daily basis.
