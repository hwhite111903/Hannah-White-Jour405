...
0.23 means there are too many of those people, 3.04 means they needed more of those people

3. Why might some respondents be weighted more heavily than others?
if that group is hard to get a hold of
...
rarely/never had the biggest difference between weighted and unweighted

2. How might these differences affect reporting on likely voter turnout?
They could expect more or less people who rarely/never vote to vote. And when you underestimate that, it could completely change the race and mislead the public.
...
These differences could exist because they want to attempt to get data from people who are hard to get a hold of, so they found a way to compensate for it. People who are going to vote are definitely overrepresented since those types of people are more likely to respond to a survey, and people who are not going to vote are underrepresented for the opposite reason.
