...
Local officials claim the new transit line has driven up home prices, and the data suggests that to be true. With a p-value of 0.000018, there is strong statistical evidence of a correlation, and home values have risen by an average of $19.5K (6.8%). However, other factors like renovations and added amenities could also be playing a small factor into this as well. While it's undenialable that the home prices and the introduction of the transit line corralate, we must look into other factors as well that were not reported on.
