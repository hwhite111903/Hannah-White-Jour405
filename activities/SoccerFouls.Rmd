...
Both the correlation calculation and the scatterplot show that fouls and goal diff have no relationship. For the calculation, we received a very low number. While not negative, it's pretty much non-existent. And then, for the scatterplot, we see no distinct pattern or lines; it's just one big blob.
