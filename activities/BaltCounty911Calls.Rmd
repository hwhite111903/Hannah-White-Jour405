...
ANSWER HERE
There’s a lot of variability, but the majority of calls hover around 8–14 per day.

Some clustering of higher or lower values appears briefly but doesn’t seem to form a clear long-term trend.

Several days clearly stand out with call counts exceeding 20.

There are a few sharp drops near 0–2 calls, which are also unusual compared to the norm.



Line at 14 calls

Mean line (around 10 calls)
...
Extra Analysis: Adds z-score logic to flag "unusual" days

Red dots = unusually high days (z > 2)

Blue dots = unusually low days (z < -2)

But my previous answer was pretty similar 
...
October 4, 2022, stood out as an extremely unusual Tuesday, with 23 overdose-related 911 calls—more than double the typical number for that day of the week. 

It's the most extreme spike in calls compared to what’s normally seen on a Tuesday, making it a significant outlier in the overall pattern.
...
"Tuesdays and Saturdays Stand Out — Are Certain Days More Dangerous for Overdoses?"

While overdoses happen every day, some days appear riskier than others. Tuesdays had the highest single-day spike, and Saturdays had the highest average call volume overall—but they also had some of the lowest call days, suggesting volatility. This could point to patterns in drug use, access to services, or how people seek help across the week. Reporting could dig into why certain days swing so widely and what public health or emergency systems are doing to respond.

Look into those unusual days: What was happening in the city on those dates? Any events, holidays, weather issues, or news stories?

Talk to experts: Ask paramedics, harm reduction workers, or health officials if they noticed anything about those days. Could they explain the spike or dip?

Check for patterns: Are these spikes clustered in certain neighborhoods? Are the same days (like Tuesdays) showing up again and again?

"I looked at 911 overdose calls and found a set of days that were way above or below normal—even after accounting for weekday patterns. One Tuesday had over twice the usual number of calls. These aren’t just outliers—they might reflect real-world events, service gaps, or signs of a worsening crisis."
