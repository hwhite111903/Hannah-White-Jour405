...
Some salary values, like extremely high or low amounts, could skew the analysis.  The zero-dollar salaries could indicate that there are missing or incorrect salaries that should be fixed before data is used.
...
The mean salary is slightly lower than the median, meaning that lower salaries like Policy Advisor are dragging it down. The zero minimum salary could be due to missing or incorrect info, but the $251,258 maximum represents a wide income range. 
...
A good story idea I would do would be exploring salary disparities. Answering questions like why are some salaries so high while others are extremely low or even $0?

The next stage in developing this story idea would be to examine the income distribution and look for trends by job type. Then I'd interview employees and experts to figure out why pay vary so much.
