...
The new test scores seem higher than before, but not by alot. I can tell this by comparing the new scores to the original average of 72.6. Which shows some improvement.
...
My initial observation was the mean increase from 72.6 to 75.75, which is a 3.15 increase. And then a change in sd from 4.8 to 1.76, which shows more consistency.
...
my_fill_color <- "navy" # Replace with a color name like "royalblue", "darkgreen", etc.
...
Third Grade Reading Scores See Slight Increase From Previous Year
...
**Hypotheses:**
Null: The new reading program ≤ The old reading programs
Alternative: The new reading program > The old reading programs
...
This p-value is very small, which tells me that the chance that this improvement happened by random luck is extremely low. A way to explain would be like this: "A statistical test shows that this improvement is extremely unlikely to be due to random chance, since there’s less than a 0.003% probability that this happened just by luck."
...
"New Reading Program Leads to Higher Test Scores with Third Graders" : Students reading scores have improved after a new reading program was introduced in local school district. The average score went up from 72.6 to 75.75, a 4.3% increase. 

Evidence does support the superintendent's claim since the p - value of 3.434782e-05 shows a strong corralation between the two things.

### Reflection Question 6:
What metrics or outcomes beyond test scores might be important to track for assessing reading performance?

Other outcomes beyond reading scores that are important to track could be :
- Whether all student groups are improving equally (race, gender, etc.)
- If they remember and apply their skills over time
- How well the students understand what they read
